...
const { SteamEmulatorParser } = require('./plugin/bkp/SteamEmulators.bkp');
// const uplay = require("./uplay.js");
// const rpcs3 = require("./rpcs3.js");
// const greenluma = require("./greenluma.js");
const userDir = require('./plugin/bkp/userDir.ts');
const blacklist = require('./plugin/bkp/blacklist.ts');
const watchdog = require('./plugin/bkp/watchdog.ts');
...
//     }
//
//     async discover(source: any): Promise<any> {
//
...
//         if (source.steamEmu) {
//             try {
//                 data = data.concat(await SteamEmulatorParser.scan(additionalSearch));
//             } catch (err) {
//                 console.log(err);
//             }
//         }
...
//             data = data.filter((appid: any) => {
//                 return !exclude.some((id: any) => id == appid.appid);
//             });
//         } catch (err) {
//             console.log(err);
//         }
